function gn = param_cons_gasNetwork_472n(gn)
...
gn.phi_max(find(gn.pairList==6),find(gn.pairList==38)) = 4000;
gn.phi_max(find(gn.pairList==38),find(gn.pairList==6)) = 4000;
...
gn.gs_max(find(gn.pairList==31)) = 10000;
gn.gs_max(find(gn.pairList==33)) = 10000;
gn.gs_max(find(gn.pairList==39)) = 15000;
end
